      ...
      <div class="mobile-overlay-backdrop">
        <div class="mobile-overlay-content">
          ...
          <p class="mobile-overlay-description">
            This DES to 3-DES encryption experiment is optimized for desktop computers with larger screens and mouse interaction.
            While you can continue on mobile, you may experience:
          </p>
          <ul class="mobile-overlay-list">
            <li>• Difficulty interacting with complex form elements</li>
            <li>• Limited screen space for cryptographic content</li>
            <li>• Reduced functionality for key manipulation</li>
